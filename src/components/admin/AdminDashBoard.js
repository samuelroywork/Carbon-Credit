...
export default function AdminDashBoard(props) {
  ...
  const handleClose2 = async () => {
    const infoValue = await myContract.methods
      .depositeEther()
      .send({ from: ethereum.selectedAddress, value: parseInt(text2) * (10 ** 18) });
    console.log(infoValue);
    getContractEtherBalance();
    getAdderssEtherBalance();
    setOpen2(false);
    ...
    <div className={classes.paper}>
      ...
      >
        ...
        <Card className={classes.root} variant="outlined">
          ...
          <CardActions>
            <Button onClick={handleClickOpen3} size="small">
              Issue Carbon Credit
            </Button>
          </CardActions>
        </Card>
        <Card className={classes.root} variant="outlined">
          ...
          <CardActions>
            <Button onClick={handleClickOpen4} size="small">
              Deposit Carbon Credit
            </Button>
          </CardActions>
        </Card>
      </Grid>
